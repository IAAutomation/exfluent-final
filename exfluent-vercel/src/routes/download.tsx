        ...
        <section>
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <button
              ...
              className={`group relative inline-flex items-center gap-3 overflow-hidden rounded-full px-6 py-4 text-sm font-medium transition-all hover:translate-y-[-1px] disabled:opacity-80 ${
                done
                  ? "bg-card border border-border text-ink"
                  : "bg-ink text-cream hover:shadow-[0_18px_40px_-15px_rgba(75,115,255,0.55)]"
              }`}
            >
              <Chrome size={18} />
              {done
            ...
            <Link
              to="/app"
              className={`inline-flex items-center gap-2 rounded-full px-6 py-4 text-sm font-medium transition-all ${
                done
                  ? "bg-ink text-cream hover:opacity-95 shadow-[0_18px_40px_-15px_rgba(75,115,255,0.55)]"
                  : "border border-input bg-card hover:border-ink text-ink"
              }`}
            >
